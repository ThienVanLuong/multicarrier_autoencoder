...
data = sio.loadmat("cons_N4M256.mat")
U4 = data['U']


data = sio.loadmat("Cons_S_OFDM_N4M4.mat")
U2 = data['U']

data = sio.loadmat("Cons_S_OFDM_IM_N4K3M4.mat")
U3 = data['U']

data = sio.loadmat("Cons_OFDM_IM_N4K3M4.mat")
U1 = data['U']
...
ax4.grid(True)
ax4.set_title('Proposed Emb-MC-AE', fontsize=12)




# fig.suptitle('Contellation for N=2 M=4', fontsize=12)
fig.savefig('cons_N4M256.png',dpi=100)
plt.show()